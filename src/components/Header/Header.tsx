  ...
  <header>
    ...
    <div className={styles.right}>
      <div>
        ...
        <div className={styles.protocol}>ПРОТОКОЛ ПОДКЛЮЧЕНИЯ СТАНДАРТА В14-23КР</div>
        <div className={styles.srever}>--- СЕРВЕР 12.423.32 (ОСТРОВ ВИЗЕ) ---</div>
        <div className={styles.coordinates}>--- КООРДИНАТЫ 79.538164, 76.88614 ---</div>
      </div>
    </div>
  </header>
);
